...
def parse_option():
    ...
    parser.add_argument('--load-path',type=str,default='checkpoints/attn_glr0.0001_dlr0.0004_advloss-wgan-gp_ep500/ep123_it17250_0.6667.pth',help='checkpoints path')
