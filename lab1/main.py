...
parser.add_argument("--hidden-size",type=tuple,default=(512,32),help="two hidden layer neuron numbers (layer1,layer2)")
...
class Model:
    ...
    def plot_result(self,data, gt_y, pred_y):
        ...
        plt.savefig(f"./results/{task}_({self.layer1},{self.layer2})_pred.jpg")
        plt.show()
